...
<html lang="fr">
    <head>
        ...
        <title>Nouvelle Agence - Insurio Central</title>
        ...
        <div class="flex h-screen overflow-hidden">
            ...
            <aside class="hidden lg:flex lg:flex-col lg:w-64 bg-[#0F172A] border-r border-[#1E293B] flex-shrink-0 text-slate-300">
                ...
                <nav class="flex-1 px-4 space-y-1 overflow-y-auto">
                    ...
                    <!-- Nouvelle Agence Link (active) -->
                    <a href="{{ route('platform.tenants.create') }}" class="flex items-center px-3 py-2.5 text-sm font-semibold rounded-xl bg-[#1E293B] text-white">
                        <svg class="h-5 w-5 mr-3 text-teal-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <header class="h-16 bg-white border-b border-slate-100 flex items-center justify-between px-6 z-10">
                    <div class="flex items-center gap-4">
                        ...
                        <h2 class="font-bold text-slate-850 text-sm">Déploiement de Cabinet</h2>
                    </div>
                                ...
                                <form action="{{ route('platform.tenants.store') }}" method="POST" class="space-y-6">
                                    ...
                                    <div class="space-y-6">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div>
                                                <label for="id" class="block text-xs font-bold uppercase tracking-wider text-slate-450 mb-2">Identifiant Unique (Tenant ID)</label>
                                                ...
                                                <p class="text-[10px] text-slate-400 mt-2 font-medium">Lettres et chiffres uniquement. Définit le sous-domaine d'accès (ex: axamaarif.sc7mosa1422.universe.wf).</p>
                                            </div>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div>
                                                <label for="email" class="block text-xs font-bold uppercase tracking-wider text-slate-455 mb-2">Email Administrateur Agence</label>
                                            ...
                                            <div>
                                                ...
                                                <select id="plan" name="plan" required
                                                    ...
                                                    <option value="gratuit" {{ old('plan') == 'gratuit' ? 'selected' : '' }}>Gratuit (Base)</option>
                                                    <option value="premium" {{ old('plan') == 'premium' ? 'selected' : '' }} selected>Premium (Commissions & SMTP)</option>
                                                    <option value="entreprise" {{ old('plan') == 'entreprise' ? 'selected' : '' }}>Entreprise (Multi-succursales)</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
