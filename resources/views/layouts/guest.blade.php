...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full">
    ...
    <body class="h-full font-sans antialiased bg-slate-50 text-slate-900 selection:bg-indigo-500 selection:text-white">

        <div class="min-h-screen grid lg:grid-cols-12 bg-slate-50 text-slate-900">
            ...
            <!-- RIGHT PANEL: 50% Enterprise Authentication Form Container (Crisp White Design) -->
            <div class="col-span-12 lg:col-span-6 flex flex-col justify-between p-6 sm:p-10 lg:p-14 xl:p-16 bg-slate-50 text-slate-900 overflow-y-auto">
