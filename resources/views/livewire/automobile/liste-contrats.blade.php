                        ...
                        <tr wire:key="contrat-row-{{ $contrat->id }}"
                            ...
                            <td class="px-2.5 py-2 whitespace-nowrap text-center font-sans">
                                <div class="inline-flex items-center gap-1.5">
                                    ...
                                    @if($contrat->statut_reglement === 'non_paye')
                                     <!-- Supprimer Contract (Non payé uniquement) -->
                                     <button wire:click.stop="deleteContrat({{ $contrat->id }})" 
                                             wire:confirm="Êtes-vous sûr de vouloir supprimer ce contrat non payé N° {{ $contrat->numero_contrat }} ?"
                                             title="Supprimer le contrat (Non payé)" 
