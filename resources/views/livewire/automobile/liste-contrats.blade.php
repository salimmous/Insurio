<div class="p-4 md:p-5 bg-slate-50 min-h-screen text-slate-800 flex flex-col gap-4">
                        ...
                        <tr wire:key="contrat-row-{{ $contrat->id }}"
                            ...
                            <td class="px-2.5 py-2 whitespace-nowrap text-center font-sans">
                                <div class="inline-flex items-center gap-1.5">
                                    ...
                                    <!-- Supprimer Contract -->
                                    <button wire:click.stop="deleteContrat({{ $contrat->id }})" 
                                            wire:confirm="Êtes-vous sûr de vouloir supprimer définitivement le contrat N° {{ $contrat->numero_contrat }} ?"
    ...
    <div class="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-40 bg-slate-900 text-white rounded-2xl px-6 py-3.5 shadow-2xl border border-slate-700 flex flex-wrap items-center gap-4 transition-all duration-300">
        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            <!-- Delete Bulk -->
            <button wire:click="bulkDelete" wire:confirm="Êtes-vous sûr de vouloir supprimer définitivement les contrats sélectionnés ?" class="px-3 py-1.5 bg-rose-600 hover:bg-rose-500 text-white rounded-xl text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer shadow-sm">
