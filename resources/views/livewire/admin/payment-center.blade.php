                            ...
                            @foreach($day['transactions'] as $item)
                                <tr class="hover:bg-slate-50 transition">
                                    ...
                                    <td class="px-6 py-3.5 text-right font-mono">
                                        ...
                                        <a href="{{ route('admin.payments.receipt', $item->id) }}" target="_blank" class="text-indigo-600 hover:text-indigo-800 hover:underline font-bold text-[11px] inline-flex items-center gap-1">
